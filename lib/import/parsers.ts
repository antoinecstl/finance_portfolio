...
// Note : pdf-parse exécute du code de test au require de l'entry-point en mode
// "main module". Comme on l'importe via require/dynamic depuis une route Next.js,
// on n'est jamais le module principal et le bloc test est inerte.
